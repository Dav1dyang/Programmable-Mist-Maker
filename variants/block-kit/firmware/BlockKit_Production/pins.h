...
constexpr bool     CFG_DEFAULT_SENSE_USE_AS_REED             = true;  // true = ignore reed switch, current-sense auto-probe is the dock trigger (default since the demo-mode work)
